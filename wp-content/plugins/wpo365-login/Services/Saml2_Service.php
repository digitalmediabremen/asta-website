<?php
    ...
    if ( !class_exists( '\Wpo\Services\Saml2_Service' ) ) {
        ...
        class Saml2_Service {
             ...
             * @return void
             */
            public static function initiate_request( $redirect_to ) {
                Log_Service::write_log( 'DEBUG', __METHOD__ . ' -> Sending SAML 2.0 authentication request' );
            ...
            public static function saml_settings( $validate = false ) {
                ...
                $x509cert = Options_Service::get_global_string_var( 'saml_x509_cert' );
