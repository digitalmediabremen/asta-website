    ...
    if ( !class_exists( '\Wpo\Tests\Test_Saml2' ) ) {
        ...
        class Test_Saml2 {
            ...
            public function test_saml2_settings() {
                ...
                $test_result = new Test_Result( 'All mandatory SAML settings are configured', 'SAML 2.0', Test_Result::SEVERITY_BLOCKING );
            ...
            public function test_process_saml2_response() {
                ...
                $test_result = new Test_Result( 'SAML response has been processed and no errors occurred', 'SAML 2.0', Test_Result::SEVERITY_BLOCKING );
                $test_result->passed = true;
            ...
            public function test_saml_response_is_authenticated() {
                $test_result = new Test_Result( 'User is authenticated', 'SAML 2.0', Test_Result::SEVERITY_BLOCKING );
                $test_result->passed = true;
            ...
            public function test_saml_response_contains_upn() {
                $test_result = new Test_Result( 'SAML response contains user principal name', 'SAML 2.0', Test_Result::SEVERITY_CRITICAL );
                $test_result->passed = true;
            ...
            public function test_saml_response_contains_first_name() {
                $test_result = new Test_Result( 'SAML response contains first name', 'SAML 2.0', Test_Result::SEVERITY_LOW );
                $test_result->passed = true;
            ...
            public function test_saml_response_contains_last_name() {
                $test_result = new Test_Result( 'SAML response contains last name', 'SAML 2.0', Test_Result::SEVERITY_LOW );
                $test_result->passed = true;
            ...
            public function test_saml_response_contains_full_name() {
                $test_result = new Test_Result( 'SAML response contains full name', 'SAML 2.0', Test_Result::SEVERITY_LOW );
                $test_result->passed = true;
