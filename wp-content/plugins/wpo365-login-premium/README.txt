=== WordPress + Microsoft Office 365 / Azure AD | SYNC ===
Contributors: wpo365
...
= v10.9 =
* Change: The PREMIUM and INTRANET edition now support mappings between Azure AD group memberships and (WordPress) groups that you created with the [Groups plugin](wordpress.org/plugins/groups/).
* Improvement: The "Plugin self-test" will now also include the ID token received during the execution of the test.
